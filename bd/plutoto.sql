...
--
-- Client :  localhost
-- Généré le :  Lun 15 Février 2016 à 15:48
...
INSERT INTO `plutoto` (`id`, `name`, `sentence`, `video`, `Valide`) VALUES
(1, 'plutoto', 'Le train est arriver plutot tot', '#', 1),
(2, 'patapote', 'c pas ta pote', '#', 1),
(7, 'axel', 'axel rambo', NULL, 1),
(14, 'mecotaké', 'Ce mec est au taquet', NULL, 1),
(20, 'tesvideo', 'un test video', 'https://www.youtube.com/watch?v=hoIA4TaB9sE', 1);
